...
public class SaveTextsApplication extends Application {
...
//                .build();
        ...
        final RealmConfiguration configuration = new RealmConfiguration.Builder().name("database.realm").schemaVersion(0).build();
